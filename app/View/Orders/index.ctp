<div class="orders index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('tailor_assigned'); ?></th>
			<th><?php echo $this->Paginator->sort('tailor_price'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($order['Order']['remarks']); ?>&nbsp;</td>
		<td><?php echo h($order['Order']['mesurements']); ?>&nbsp;</td>
		<td><?php echo h($order['Order']['order_date']); ?>&nbsp;</td>
		<td><?php echo h($order['Order']['delivery_date']); ?>&nbsp;</td>
		<td><?php echo h($order['Order']['tailor_date']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($order['User']['id'], array('controller' => 'users', 'action' => 'view', $order['User']['id'])); ?>
		</td>
		<td><?php echo h($order['Order']['tailor_assigned']); ?>&nbsp;</td>
		<td><?php echo h($order['Order']['tailor_price']); ?>&nbsp;</td>
