<div class="dresses index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $dress['Dress']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $dress['Dress']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $dress['Dress']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $dress['Dress']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
